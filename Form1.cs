    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            txtMessageText.Text = "Startup..."; try
            {
                ...
                SqlConnection connection = new(@"Data Source=YARUSHAH\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");
                connection.Open();
        ...
        private void BtnView_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection connection = new(@"Data Source=YARUSHAH\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True;TrustServerCertificate=True");
            connection.Open();
